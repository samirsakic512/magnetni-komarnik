(() => {
  ...
  let selected = '1';
  let addons = { warranty: false, priority: false, insurance: false };
  ...
  form.addEventListener('submit', async e => {
    ...
    try{
      ...
      submitBtn.textContent = 'Potvrdi narudžbu';
    }
  });
